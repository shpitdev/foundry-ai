...
- Select the SDK for the served proxy protocol, not just the model creator. Kimi/GLM remain third-party; their observed combined tool/JSON failures have a staged workaround, not a verified SDK replacement. See `../../docs/README.md#sdk-selection-and-reasoning-diagnostics`.
